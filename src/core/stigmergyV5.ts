...
export class StigmergyV5 {
  ...
  getResonance(context: ContextTensor): ResonanceResult {
    ...
    for (let t = 0; t < traceCount; t++) {
      ...
      // Inline dot product for maximum performance in the hot loop
      // We manually inline part of cosineWithMagnitudes logic here to save function call overhead
      // which is critical when iterating over potentially thousands of traces.
